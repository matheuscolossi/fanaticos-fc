...
function renderCheckoutStep1() {
  ...
  content.innerHTML = `
    ...
    <div class="co-form">
      <h3 class="co-section-title">Seus Dados</h3>
      <div class="co-form-row">
        <div class="co-form-group">
          <label>Nome completo *</label>
          <input type="text" id="co_nome" placeholder="João da Silva" />
        </div>
        <div class="co-form-group">
      ...
      <div class="co-form-row">
        <div class="co-form-group">
          <label>E-mail *</label>
          <input type="email" id="co_email" placeholder="joao@email.com" />
        </div>
      </div>
      <div class="co-form-row">
        <div class="co-form-group">
          <label>Endereço (Rua, Número, Bairro) *</label>
          <input type="text" id="co_endereco" placeholder="Rua das Flores, 123, Centro" />
        </div>
        <div class="co-form-group">
          <label>Cidade / Estado *</label>
          <input type="text" id="co_cidade" placeholder="Porto Alegre / RS" />
        </div>
      </div>
      <div class="co-form-row">
        <div class="co-form-group">
  ...
  document.getElementById('trackingContent').innerHTML = `
    ...
    <div class="co-form">
      <div class="co-form-group">
        ...
        <input type="number" id="trackingId" placeholder="Ex: 42" min="1" />
      </div>
      <button type="button" id="btnBuscarRastreio" class="btn btn--primary co-btn-submit">Rastrear →</button>
    </div>
